 ...
 */
public abstract class FireBaseSarpraAdapter<ViewHolder extends RecyclerView.ViewHolder, T>
    ...
    private ChildEventListener mListener = new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            if (!mKeys.contains(key)) {
                T item = dataSnapshot.getValue(FireBaseSarpraAdapter.this.mItemClass);
        ...
        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
            ...
            if (mKeys.contains(key)) {
                ...
                T newItem = dataSnapshot.getValue(FireBaseSarpraAdapter.this.mItemClass);
     ...
     */
    public FireBaseSarpraAdapter(Query query, Class<T> itemClass) {
